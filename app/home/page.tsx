...
export default function MediaHub() {
  ...
  const socials = [
    { 
      name: "YouTube", 
      url: "https://www.youtube.com/@Liminalarcmedia/featured",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 2-2 58.38 58.38 0 0 1 15 0 2 2 0 0 1 2 2 24.12 24.12 0 0 1 0 10 2 2 0 0 1-2 2 58.38 58.38 0 0 1-15 0 2 2 0 0 1-2-2Z"/><path d="m10 15 5-3-5-3z"/></svg>
      )
    },
    { 
      name: "TikTok", 
      url: "https://www.tiktok.com/@liminalarcmedia",
      icon: (
    ...
    { 
      name: "Instagram", 
      url: "https://www.instagram.com/liminalarcmedia/",
      icon: (
  ...
  return (
    <main className="relative min-h-screen w-full bg-black text-white selection:bg-white/30 overflow-x-hidden font-sans">

      {/* 1. MOTION & GLOW ENGINE */}
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @keyframes stellar-glow {
          ...
          50% { text-shadow: 0 0 30px rgba(255,255,255,0.8), 0 0 50px rgba(255,255,255,0.3); }
          100% { text-shadow: 0 0 10px rgba(255,255,255,0.4); }
        }
        @keyframes icon-pulse {
          0% { filter: drop-shadow(0 0 2px rgba(255,255,255,0.2)); transform: scale(1); }
          50% { filter: drop-shadow(0 0 15px rgba(255,255,255,0.6)); transform: scale(1.1); }
          100% { filter: drop-shadow(0 0 2px rgba(255,255,255,0.2)); transform: scale(1); }
        }
      `}} />

      {/* 2. BACKGROUND STARFIELD */}
      <div className="fixed inset-0 z-0 h-full w-full pointer-events-none overflow-hidden bg-black">
        {stars.map((star, i) => (
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-24 flex flex-col items-center">
        ...
        <div className="mb-48 flex flex-col items-center text-center">
          <img
            src="/lam-logo-mark.png"
            alt="Liminal Arc Media"
            className="h-32 md:h-52 w-auto select-none mix-blend-screen" 
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 w-full mb-12">
          ...
          <a href="https://youtu.be/c3TFhMDaf4w?si=d85QKXGEoOArUPtO" target="_blank" rel="noopener noreferrer" className="group relative h-[650px] overflow-hidden rounded-[3.5rem] border border-white/10 bg-white/[0.01] backdrop-blur-3xl flex flex-col justify-end text-center p-10 hover:border-white/40 transition-all duration-500 shadow-2xl">
          ...
          <Link href="/originals" className="group relative h-[650px] overflow-hidden rounded-[3.5rem] border border-white/10 bg-white/[0.01] backdrop-blur-3xl flex flex-col justify-end text-center p-10 hover:border-white/40 transition-all duration-500 shadow-2xl">
          ...
          <Link href="/readycheck-av" className="group relative h-[650px] overflow-hidden rounded-[3.5rem] border border-white/10 bg-white/[0.01] backdrop-blur-3xl flex flex-col justify-end text-center p-10 hover:border-white/40 transition-all duration-500 shadow-2xl">
            ...
            <div className="relative z-20">
              ...
              <h3 className="text-4xl font-bold italic uppercase mb-2 tracking-tighter">ReadyCheck AV</h3>
              <div className="h-[1px] w-6 bg-white/10 mx-auto group-hover:w-24 group-hover:bg-white transition-all" />
            </div>
          </Link>
        </div>

        {/* 5. THE LIORA SIGNAL PANEL */}
        <Link href="/liora-signal" className="group relative w-full h-64 rounded-[3.5rem] border border-white/10 bg-black overflow-hidden flex items-center justify-between px-16 shadow-2xl transition-all hover:border-white/40 mt-12 mb-32">
        ...
        {/* 6. GLOWING FACEBOOK LINK & SOCIALS */}
        <div className="mb-48 flex flex-col items-center text-center">
          ...
          <a 
            ...
            className="group flex flex-col items-center cursor-pointer mb-16"
          >
            ...
            <h2 
              className="mt-4 text-4xl md:text-8xl font-black italic tracking-normal uppercase text-white/60 group-hover:text-white transition-all duration-700"
            >
              <span className="group-hover:[animation:stellar-glow_3s_ease-in-out_infinite]">
                Join the Community
              </span>
            </h2>
        ...
        <footer className="w-full mt-24 py-20 border-t border-white/5 flex justify-between items-center opacity-30 text-[11px] font-mono uppercase tracking-[0.8em]">
            ...
            <div className="flex gap-12 tracking-[0.4em]">
              <a href="https://www.youtube.com/@LiminalArcMedia" target="_blank" className="hover:text-white transition-colors">YouTube</a>
              <a href="mailto:liminalarcmedia@gmail.com" className="hover:text-white transition-colors underline underline-offset-8">Inquiries</a>
            </div>
        </footer>
      </div>
    </main>
