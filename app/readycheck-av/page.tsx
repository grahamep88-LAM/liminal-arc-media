  ...
  return (
    <main className="relative min-h-screen w-full bg-[#020202] text-white selection:bg-sky-500/30 overflow-x-hidden font-mono">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[40vh] bg-sky-600/5 blur-[120px]" />
      </div>

      {/* 3. NAVIGATION */}
      <nav className="relative z-50 p-10">
        <Link href="/home" className="group flex items-center gap-4 text-[10px] tracking-[0.5em] text-white/30 hover:text-sky-400 transition-all">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10 pb-32">
        {subCategories.map((cat) => (
          <a 
            ...
            className="group relative aspect-[4/5] overflow-hidden border border-white/5 bg-white/[0.02] hover:border-sky-500/40 transition-all duration-500 shadow-2xl cursor-pointer"
          >
            <img 
              src={cat.img} 
              alt={cat.title} 
              className="absolute inset-0 w-full h-full object-cover opacity-20 grayscale group-hover:grayscale-0 group-hover:opacity-60 group-hover:scale-105 transition-all duration-1000" 
            />
            ...
            <div className="absolute inset-0 p-10 flex flex-col justify-end text-left">
              ...
              <h3 className="text-2xl font-bold uppercase italic mb-3 tracking-widest">{cat.title}</h3>
      ...
      <section className="relative z-10 flex flex-col items-center text-center pb-40">
        ...
        >
          ...
          <div className="flex items-center gap-8 mb-8">
             <h2 
              className="text-4xl md:text-7xl font-black italic uppercase text-white/40 group-hover:text-white transition-all duration-700"
            >
              <span className="group-hover:[animation:tech-glow-sky_3s_ease-in-out_infinite]">
                Join the Group
              </span>
            </h2>

            <div className="w-16 h-16 rounded-full border border-white/10 flex items-center justify-center transition-all duration-700 group-hover:bg-sky-600 group-hover:border-sky-600 group-hover:scale-110 shadow-[0_0_20px_rgba(14,165,233,0.1)]">
          ...
          <div className="h-[1px] w-12 bg-sky-500/20 group-hover:w-72 group-hover:bg-sky-500 transition-all duration-1000 ease-in-out" />
        </a>
      </section>
